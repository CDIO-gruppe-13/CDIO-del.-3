...
public abstract class GameLogic {
  ...
  final BoardSpace[] boardSpaces = {
      ...
      new PropertySpace(
          "Candy Store",
          "You've passed the Candy Store!",
          1,
          Color.LIGHT_BLUE),
      new PropertySpace(
          "Icecream Stall",
          "You've passed the Icecream Stall!",
          1,
          Color.LIGHT_BLUE),
      new PassiveSpace("Jail Visit", "You're visting your uncle in Jail!"),
      new PropertySpace("Museum", "You've passed the Museum!", 2, Color.PINK),
      new PropertySpace(
          "Library",
          "You've passed the Library!",
          2,
          Color.PINK),
      new ChanceSpace("Chance", "You've passed the Chance!"),
      new PropertySpace(
          "Skate Park",
          "You've passed the Skate Park!",
          2,
          Color.ORANGE),
      new PropertySpace("The Pool", "You've passed the Pool!", 2, Color.ORANGE),
      new PassiveSpace("Free parking", "You've passed the Free parking!"),
      new PropertySpace(
          "Arcade",
          "You've passed the Arcade!",
          3,
          Color.RED),
      new PropertySpace("Cinema", "You've passed the Cinema!", 3, Color.RED),
      new ChanceSpace("Chance", "You've passed the Chance!"),
      new PropertySpace(
          "Toy Store",
          "You've passed the the Toy Store!",
          3,
          Color.YELLOW),
      new PropertySpace(
          "Pet Shop",
          "You've passed the Pet Shop!",
          3,
          Color.YELLOW),
      new JailSpace("Jail", "You're going straigt to Jail!"),
      new PropertySpace(
          "Bowling Alley",
          "You've passed the Bowling Alley!",
          4,
          Color.GREEN),
      ...
      new PropertySpace(
          "Water Park",
          "You've passed the Water Park!",
          5,
          Color.DARK_BLUE),
      new PropertySpace(
          "The beach promenade",
          "You've passed The beach promenade!",
          5,
          Color.DARK_BLUE),
  };
  ...
  protected void initPlayers() {
    ...
    while (true) {
      ...
      try {
        ...
        if (playerAmount < 2 || 4 < playerAmount)
          throw new Exception();
        break;
      } catch (Exception e) {
        ...
        case 2:
          while (true) {
            ...
            try {
              ...
              if (userInputInt < 1 || 5 < userInputInt)
                throw new Exception();
